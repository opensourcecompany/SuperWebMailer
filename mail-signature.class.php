...
class mail_signature {
 ...
 var $options;
	//@private
 var $canonicalized_headers_relaxed;

	//public function __construct($private_key, $passphrase, $domain, $selector, $options = array()){
 function __construct($private_key, $passphrase, $domain, $selector, $options = array()){

  // M.B.
  if( strpos($private_key, "file:") !== false || strpos($private_key, "http:") !== false || strpos($private_key, "https:") !== false )
...
/*		}
 ...
 function mail_signature($private_key, $passphrase, $domain, $selector, $options = array()){
   self::__construct($private_key, $passphrase, $domain, $selector, $options);
 }
