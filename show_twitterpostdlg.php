...
#############################################################################
  ...
  // Template
  $_QLJfI = GetMainTemplate(true, $UserType, $Username, true, $resourcestrings[$INTERFACE_LANGUAGE]["000740"], $_Itfj8, 'browsecampaigns', 'twitter_post.htm');
  ...
  if(empty($_POST["twittertweet"])) {
    ...
    $_POST["twittertweet"] = $_QLO0f["MailSubject"]."\r\n".$_8ILOQ;
  }
  ...
  function _JOPLD($_j01fj){
    ...
    $_jfJJ0 = $_QLi60;
    $_QLfol = "SELECT Name, CurrentSendTableName FROM $_jfJJ0 WHERE id=$_j01fj";
    $_QL8i1 = mysql_query($_QLfol);
    _L8D88($_QLfol);
    $_QLO0f=mysql_fetch_array($_QL8i1);
    $_jClC1 = $_QLO0f["CurrentSendTableName"];
    ...
    if(mysql_num_rows($_QL8i1) != 1) {
      ...
      $_QLJfI = GetMainTemplate(true, $UserType, $Username, true, $resourcestrings[$INTERFACE_LANGUAGE]["000740"], $_Itfj8, 'DISABLED', 'twitter_post_sententry_select.htm');
