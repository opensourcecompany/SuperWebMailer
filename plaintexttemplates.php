...
#############################################################################
  ...
  // Template
  $_QLJfI = GetMainTemplate(true, $UserType, $Username, true, $resourcestrings[$INTERFACE_LANGUAGE]["000810"].$resourcestrings[$INTERFACE_LANGUAGE]["EntryCount"], $_Itfj8, 'DISABLED', 'browse_plaintexttemplates.htm');
  ...
  function _LBC6F($_QLfol, $_QLoli) {
    ...
    $_QLfol = str_replace('{}', 'id, Name, MailPlainText, IsDefault, UsersOption', $_QLfol);
