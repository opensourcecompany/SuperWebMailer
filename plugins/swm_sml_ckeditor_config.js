...
CKEDITOR.editorConfig = function( config )
{
    ...
    [
        ...
        { name: 'insert',      items : [ 'Image','Table','HorizontalRule','Smiley','SpecialChar','EmojiPanel','PageBreak' ] },
        '/',
   ...
   // devtools,
   var _plugins = 'docprops,placeholdercb,queryfunctionbtn,textblocksbtn,loadfilebtn,smebarbtn,tableresize,codemirror,dragresize,pixabaybtn,pastefromlibreoffice,tableclonerow,emoji';
