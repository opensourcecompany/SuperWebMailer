                ...
                elements: [
                    {
                        type:  'html',
                        html:  '' +
                               '<p>' + editor.lang.targetgroups.tgroupAssignToTagDialogLabel + '</p><br /><iframe id="__targetgroupsIframe" style="width: 100%; height: 250px" border="0" marginheight="0" marginwidth="0" frameborder="0" src="./ajax_showtargetgroups.php"></iframe><br />' +
