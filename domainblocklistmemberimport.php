...
#############################################################################
  ...
  if ( (isset($_POST["action"]) && $_POST["action"] == "local") ||
       (isset($_GET["action"]) && $_GET["action"] == "local")
         ...
         if (! isset($_POST["OneMailingListId"]) && ! isset($_GET["OneMailingListId"]) ) {
           $_I0600 = $resourcestrings[$INTERFACE_LANGUAGE]["001140"];
  ...
  if($_IjfLj)
   $_Iji86 = $resourcestrings[$INTERFACE_LANGUAGE]["001139"];
   else
   $_Iji86 = $_IjOJC." - ".$resourcestrings[$INTERFACE_LANGUAGE]["001140"];

  if(!isset($_POST["step"])) {

    $_QJCJi = GetMainTemplate(true, $UserType, $Username, true, $_Iji86, "", 'domainblocklistmemberimport', 'blocklistimport1_snipped.htm');
    $_QJCJi = str_replace("blocklistmemberimport.php", "domainblocklistmemberimport.php", $_QJCJi);
    ...
    exit;
      ...
      if( isset( $_FILES['file1'] ) && $_FILES['file1']['tmp_name'] != "" && $_FILES['file1']['name'] != "" ) {
        ...
        if (move_uploaded_file($_FILES['file1']['tmp_name'], $_I0lQJ.$_FILES['file1']['name'])){
           ...
           $_QJCJi = GetMainTemplate(true, $UserType, $Username, true, $_Iji86, sprintf($resourcestrings[$INTERFACE_LANGUAGE]["000055"], $_FILES['file1']['tmp_name'], $_I0lQJ.$_FILES['file1']['name'] ), 'domainblocklistmemberimport', 'blocklistimport1_snipped.htm');
           $_QJCJi = str_replace("blocklistmemberimport.php", "domainblocklistmemberimport.php", $_QJCJi);
           $_QJCJi = str_replace("browseblmembers.php", "browsedomainblmembers.php", $_QJCJi);
           $_QJCJi = str_replace('/userfiles/import', $_I0lQJ, $_QJCJi);
           $_I00tC = ini_get("upload_max_filesize");
      ...
      $_IjLJt = _LQB6D("DomainBlockListImportOptions");
      $_IjlJf = $_POST;
      unset($_IjlJf["step"]);
      unset($_IjlJf["action"]);
      if( $_IjLJt != "" ) {
    ...
    $_QJCJi = GetMainTemplate(true, $UserType, $Username, true, $_Iji86, $_I0600, 'domainblocklistmemberimport', 'blocklistimport3_snipped.htm');
    $_QJCJi = str_replace("blocklistmemberimport.php", "domainblocklistmemberimport.php", $_QJCJi);
    $_QJCJi = str_replace("browseblmembers.php", "browsedomainblmembers.php", $_QJCJi);
    ...
    $_Q66jQ = str_replace('<!--FIELD'.$_Q6llo.'-->', $resourcestrings[$INTERFACE_LANGUAGE]["DomainName"], $_Q66jQ);
    $_Q66jQ = str_replace('<!--VALUE'.$_Q6llo.'-->', '<select name="fields['."Domainname".']" size="1">'.$_QfoQo.'</select>', $_Q66jQ);
    ...
    $_QJCJi = GetMainTemplate(true, $UserType, $Username, true, $_Iji86, "", 'domainblocklistmemberimport', 'blocklistimport4_snipped.htm');
    $_QJCJi = str_replace("blocklistmemberimport.php", "domainblocklistmemberimport.php", $_QJCJi);
    $_QJCJi = str_replace("browseblmembers.php", "browsedomainblmembers.php", $_QJCJi);
    ...
    $_QJCJi = GetMainTemplate(true, $UserType, $Username, true, $_Iji86, "", 'domainblocklistmemberimport', 'blocklistimport5_snipped.htm');
    $_QJCJi = str_replace("blocklistmemberimport.php", "domainblocklistmemberimport.php", $_QJCJi);
    $_QJCJi = str_replace("browseblmembers.php", "browsedomainblmembers.php", $_QJCJi);
    ...
    if(isset($_POST["fileposition"])) {
        ...
        if($_IJ0tL == -1 || feof($_QCC8C) || ftell($_QCC8C) >= $_QLjff["size"] ) {
          ...
          $_QJCJi = GetMainTemplate(true, $UserType, $Username, true, $_Iji86, $_I0600, 'domainblocklistmemberimport', 'blocklistimport6_snipped.htm');
          $_QJCJi = str_replace("blocklistmemberimport.php", "domainblocklistmemberimport.php", $_QJCJi);
          $_QJCJi = str_replace("browseblmembers.php", "browsedomainblmembers.php", $_QJCJi);
    ...
    if( isset($_POST["OneMailingListId"]) && $_POST["OneMailingListId"] != "" ) {
       $_IJQJ8 = str_replace('browsedomainblmembers.php"', 'browsedomainblmembers.php?action=local&OneMailingListId='.$_POST["OneMailingListId"].'"', $_IJQJ8);
       $_IJQJ8 = str_replace('domainblocklistmemberimport.php', 'domainblocklistmemberimport.php?action=local&OneMailingListId='.$_POST["OneMailingListId"], $_IJQJ8);
       $_IJQJ8 = str_replace('exportdomainblocklist.php', 'exportdomainblocklist.php?action=local&OneMailingListId='.$_POST["OneMailingListId"], $_IJQJ8);
    }
    ...
    for($_Q6llo=$_IJQQI; ($_Q6llo<$_IJQQI + intval($_POST["ImportLines"])) && !feof($_QCC8C); $_Q6llo++) {
      $_IJ0Jo++;
      $_IJ1QJ = fgets($_QCC8C, 4096);
      // UTF8?
      if ( !( isset($_POST["IsUTF8"]) && $_POST["IsUTF8"] != "") ) {
      ...
      foreach($_I16jJ as $_I1i8O => $_IJQOL) {
        ...
        if(isset($_I16jJ[$_I1i8O]) && $_I1L81 != -1) {
          ...
          if($_I1i8O == "Domainname") {
            ...
            if(strpos($_I1L81, '@') !== false) {
              $_I1L81 = substr($_I1L81, strpos($_I1L81, '@') + 1);
            }

            if( !_OPAOJ('info@'.$_I1L81) ) {
              $_QJlJ0 = ""; // invalid
              break;
            }
          }
    ...
    $_IJQQI += intval($_POST["ImportLines"]);
    $_IJ0tL = ftell($_QCC8C);
    if(feof($_QCC8C))
      $_IJ0tL = -1;
  ...
  function _OL086($errors, $_I1l66, $_I0600 = "") {
    ...
    $_QJCJi = GetMainTemplate(true, $UserType, $Username, true, $_Iji86, $_I0600, 'domainblocklistmemberimport', 'blocklistimport2_snipped.htm');
    $_QJCJi = str_replace("blocklistmemberimport.php", "domainblocklistmemberimport.php", $_QJCJi);
    $_QJCJi = str_replace("browseblmembers.php", "browsedomainblmembers.php", $_QJCJi);
    ...
    while (false !== ($_Q6lfJ = readdir($_QCC8C))) {
      if (!is_dir($_I0lQJ.$_Q6lfJ) && $_Q6lfJ != "." && $_Q6lfJ != ".." && $_Q6lfJ != "index.php") {
        $_I16oJ .= '<option value="'.$_Q6lfJ.'">'.$_Q6lfJ.'</option>'.$_Q6JJJ;
      }
    }
    closedir($_QCC8C);
